...
def main():
        ...
        print("La palbra correcta es:",palabraCorrecta)
                            ...
                            if len(palabraCorrecta)!=len(palabraUsuario):
                                ...
                                if palabraUsuario not in listaPalabrasDiccionario:
                                    ...
                                    if palabraUsuario in ListaDePalabrasUsuario:
                                        ...
                                        ## Si no hay ningun problema con la palabra ingresada no mostramos ningun mensaje de error
                                        mensaje=""
                                        ## Para que el teclado pinte solo las de la ultima palabra ingresada debemos vaciar las listas despues de cada palabra
                                        correctas = []
                                        incorrectas = []
                                        casi = []
                                        ## Se evalúa si el usuario ganó
                                        gano = revision(palabraCorrecta, palabraUsuario, correctas, incorrectas, casi)
                                        ## Se agrega la palbra ingresada a la lista de palabras ingresadasS
        ...
        if gano:
            ...
            screen.fill(COLOR_FONDO)
            ## Se cambia a la pantalla corespondiente
